...
import instructions.control.goto_.GOTO;
import instructions.control.return_.*;
import instructions.control.switch_.*;
...
public class InstructionFactory {
    ...
    static {
        ...
        map.put(0x85, new I2L());
        map.put(0x86, new I2F());
        map.put(0x87, new I2D());
        map.put(0x88, new L2I());
        map.put(0x89, new L2F());
        map.put(0x8a, new L2D());
        map.put(0x8b, new F2I());
        map.put(0x8c, new F2L());
        map.put(0x8d, new F2D());
        map.put(0x8e, new D2I());
        map.put(0x8f, new D2F());
        map.put(0x90, new D2F());
        map.put(0x91, new I2B());
        map.put(0x92, new I2C());
        map.put(0x93, new I2S());
        map.put(0x94, new LCMP());
        map.put(0x95, new FCMPL());
        map.put(0x96, new FCMPG());
        map.put(0x97, new DCMPL());
        map.put(0x98, new DCMPG());
        ...
        map.put(0xaa, new TABLE_SWITCH());
        map.put(0xab, new LOOKUP_SWITCH());
